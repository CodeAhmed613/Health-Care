...
<div className="footer-content" style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '30px', maxWidth: '1200px', margin: '0 auto'}}>
    ...
    <div className="footer-section">
        <h4>Help & Legal</h4>
        <ul style={{listStyle: 'none', padding: 0}}>
            <li><Link to="/help#faq" style={footerLink}>FAQs</Link></li>
            <li><a href="/help#policies" style={footerLink}>Policies</a></li>
            <li><a href="/help#terms" style={footerLink}>Terms & Conditions</a></li>
        </ul>
    </div>
